...
def main():
    ...
    with col2:
        ...
        with st.expander(
            ...
            # As of Streamlit Version 1.36 Embedded pages are easier to implement.
            # For my projects that have live applications I want to be able to
            # Interact with an embedded instance of them.
            branch_p1 = st.Page(
                "./embeddings/branch_library.py",
                title="Application"
            )
            branch_pg = st.navigation([branch_p1])
            branch_pg.run()
